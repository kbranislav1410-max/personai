...
const navigation = [
  ...
  { name: 'Analysis History', href: '/analysis-runs', icon: '📋' },
];
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-40 w-64 transform bg-white border-r border-gray-200 transition-transform duration-300 ease-in-out lg:translate-x-0 ${
