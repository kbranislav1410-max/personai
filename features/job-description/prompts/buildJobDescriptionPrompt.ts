...
export function buildJobDescriptionPrompt(
  ...
  const { description, seniority, location, employmentType, language } = input;
...
List 6–10 bullet points covering the essential skills, experience, and qualifications required for this role. Be specific and realistic.

## Nice-to-have
List 3–6 bullet points covering additional skills or experience that would be advantageous but are not mandatory.

## Benefits
List 5–8 bullet points describing the benefits, perks, and growth opportunities offered to the successful candidate.
